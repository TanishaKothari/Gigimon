...
export default function Home() {
  ...
  return (
    <div className="h-screen grid grid-rows-[auto_1fr] grid-cols-3">
      <div id="header" className="col-span-3 bg-[var(--color-primary)] h-[75px] flex relative items-center">
      ...
      <div id="list-and-buttons" className="col-span-1 grid grid-rows-[2fr_1fr] h-full">
        
        <div id="list" className="bg-[var(--color-quaternary)] flex flex-col gap-2 p-2 overflow-y-auto min-h-0" style={{ minHeight: 0 }}>
          {needs.map((need, idx) => (
            <NeedCard
              key={idx}
              name={need.name}
